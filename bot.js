...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/oauth2/authorize?client_id=530724114613141526&scope=bot&permissions=8`)
...
// THIS  MUST  BE  THIS  WAY
client.login('NTMwNzI0MTE0NjEzMTQxNTI2.DxDkAQ.6absyar19yPgMFAbX5pEXUyJL6E');
			      
const developers = ["398462686314364929"]//Toxic Codes
